        ...
        async function fetchLikedData() {
            try {
                ...
                likedSongs.sort((a, b) => new Date(b.liked_time) - new Date(a.liked_time));
                likedArtists.sort((a, b) => new Date(b.liked_time) - new Date(a.liked_time));
                likedAlbums.sort((a, b) => new Date(b.liked_time) - new Date(a.liked_time));
